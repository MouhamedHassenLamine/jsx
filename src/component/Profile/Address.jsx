...
export default function Address() {
  ...
  return (
    <div>
      ...
      <hr/>{/* the gray line */}
      <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Et, vitae eum nam magni quibusdam animi ullam harum minima modi minus vel placeat, dolor cupiditate reprehenderit voluptates a cumque repellendus iure!</p>
      <a onClick={explosion} href="#Boom">Show more</a>
